        ...
        ZStack {
            ...
            case .cameraPermission:
                PermissionRequestView(
                    ...
                    description: String(localized: "Atoll Island includes a mirror feature that lets you quickly check your appearance using your camera, right from the notch. Camera access is required only to show this live preview. You can turn the mirror feature on or off at any time in the app."),
            ...
            case .calendarPermission:
                PermissionRequestView(
                    ...
                    description: String(localized: "Atoll Island can show all your upcoming events in one place. Access to your calendar is needed to display your schedule."),
